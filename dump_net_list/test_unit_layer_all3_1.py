'''
dump wire layer0 layer1 layer2 first point netlist
to P(2000)
...
import os
import shutil
from test_unit_layer3_1 import dump_unit_layer1
            ...
            for m in range(input_fm.shape[2]):  # 16
                if l <= 7:
                    if m <= 7:
                        ...
                        if value_temp == -1:
                            value_temp = 0
                            point_dict[point_list_name[j]] = value_temp
                        else:
                            point_dict[point_list_name[j]] = value_temp
                        j += 1
                i += 1
...
if __name__ == "__main__":
    for i in range(2):
        ...
        if i == 1:
            ...
            input_fm = np.load(str(input_fm_p))
            weights = np.load(str(weights_p))
            filename = "test_unit/test_unit_one.v"
