...
from test_unit_layer3_8 import dump_unit_layer3
from test_unit_layer3_8 import dump_unit_layer4
...
if __name__ == "__main__":
    for i in range(5):
        ...
        if i == 2:
            ...
            file_p = "test_unit_layer_234_20.v"
        ...
        if i == 3:
            ...
            input_fm = np.load(str(input_fm_p))
            weights = np.load(str(weights_p))
            filename = "test_unit/test_unit_layer_234_20.v"
