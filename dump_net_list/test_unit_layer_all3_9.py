...
from test_unit_layer3_9 import dump_unit_layer3
from test_unit_layer3_9 import dump_unit_layer4
...
if __name__ == "__main__":
    for i in range(5):
        ...
        if i == 0:
            input_fm_p = "fm_7/feature2.fm.npy"
            weights_p = "param_7/features2.0.weight.npy"

            file_p = "test_unit_all_layer_7x7.v"
        ...
        if i == 1:
            input_fm_p = "fm_7/feature3.fm.npy"
            weights_p = "param_7/features3.0.weight.npy"
            ...
            input_fm = np.load(str(input_fm_p))
            weights = np.load(str(weights_p))
            filename = "test_unit/test_unit_all_layer_7x7.v"
        ...
        if i == 2:
            input_fm_p = "fm_7/feature4.fm.npy"
            weights_p = "param_7/features4.0.weight.npy"
