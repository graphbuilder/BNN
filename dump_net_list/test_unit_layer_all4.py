...
from test_unit_layer4 import dump_unit_layer2
from test_unit_layer4 import dump_unit_layer3
from test_unit_layer4 import dump_unit_layer4
...
if __name__ == "__main__":
    for i in range(5):
        ...
        if i == 0:
            input_fm_p = "fm_14/feature1.fm.npy"
            weights_p = "param_14/features1.0.weight.npy"
        ...
        if i == 1:
            input_fm_p = "fm_14/feature2.fm.npy"
            weights_p = "param_14/features2.0.weight.npy"
            # file_p = "test_unit_all_layer_14.v"
            pre_pad_stride_p = 0
            pad_stride_p =  0
            next_pad_stride_p = 0
            ...
            input_fm = np.load(str(input_fm_p))
            weights = np.load(str(weights_p))
            filename = "test_unit/test_unit_all_layer_14.v"
        ...
        if i == 2:
            input_fm_p = "fm_14/feature3.fm.npy"
            weights_p = "param_14/features3.0.weight.npy"
        ...
        if i == 3:
            input_fm_p = "fm_14/feature4.fm.npy"
            weights_p = "param_14/features4.0.weight.npy"
