...
delete layer0~1, save layer2~4
last layer 32 
new structure 7*7 input
'''
...
# from test_unit_layer3_2 import dump_unit_layer2
from test_unit_layer3_12 import dump_unit_layer3
from test_unit_layer3_12 import dump_unit_layer4
...
# python test_unit_layer_all3_12.py
def dump_unit_layer2(filename, layer_idx, input_fm, weights, pre_pad_stride, pad_stride, next_pad_stride, max_stride):
            ...
            for i in range (out_fm_c):  # 8
                for j in range(conv_fm_h):  # 7
                    for k in range(conv_fm_w):  # 7
                        ...
                        h += 1
        # f.write("endmodule")
        f.write("//layer2 done, begain next layer\n")
        print("layer2 done, next layer ctrl F layer0")
    f.close()
...
if __name__ == "__main__":
    for i in range(5):
        ...
        if i == 0:
            input_fm_p = "fm_7_32/feature2.fm.npy"
            weights_p = "param_7_32/features2.0.weight.npy"

            file_p = "test_unit_all_layer_7x7_32.v"
        ...
        if i == 1:
            input_fm_p = "fm_7_32/feature3.fm.npy"
            weights_p = "param_7_32/features3.0.weight.npy"
            ...
            input_fm = np.load(str(input_fm_p))
            weights = np.load(str(weights_p))
            filename = "test_unit/test_unit_all_layer_7x7_32.v"
        ...
        if i == 2:
            input_fm_p = "fm_7_32/feature4.fm.npy"
            weights_p = "param_7_32/features4.0.weight.npy"
