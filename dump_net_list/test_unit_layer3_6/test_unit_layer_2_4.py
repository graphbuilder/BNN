...
def dump_unit_layer4(filename, layer_idx, input_fm, weights, pre_pad_stride, pad_stride, next_pad_stride, max_stride):
    ...
    W_unit = []
    for j in range(out_fm_c):   # 8
        for k in range(int(input_fm_c / 2) + 2):  # 4
        ...
        for i in range(out_fm_c):  # 8
            for k in range(input_fm_h_):  # 14
                for l in range(input_fm_w_):  # 14
                    ...
                    for j in range(int(input_fm_c / 2) + 2):  # 4
                        c_unit_idx = 'c' + \
                                    str(layer_idx) + \
                                    str(int2str(j)) + \
                                    str(int2str(k)) + \
    ...
    weights_list = []
    for j in range(out_fm_c):  # 8
        for k in range(int(weights_c / 2) + 2):  # 4
            for l in range(weights_h):  # 3
                for m in range(weights_w):  # 3
                    temp = 'W' + \
                            str(layer_idx) + \
        ...
        for i in range(out_fm_c):  # 8
            for j in range(input_fm_h_):  # 14
                for k in range(input_fm_w_):   # 14
                    for l in range(int(input_fm_c / 2) + 2):  # 3
                    ...
                    for m in range(int(input_fm_c / 2) + 2):
                        if m == int(input_fm_c / 2) + 2 - 1:
