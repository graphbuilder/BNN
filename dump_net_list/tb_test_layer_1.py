...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        files = "test_tb_layer_" + str(layer_idx) + ".v"
        ...
        files = "answer_layer_" + str(layer_idx) + ".txt"
        filename2 = set_dir(filepath = 'test_tb', file = str(files))
