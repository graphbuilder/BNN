...
from test_unit_layer4_2 import dump_unit_layer2
from test_unit_layer4_2 import dump_unit_layer3
from test_unit_layer4_2 import dump_unit_layer4
...
# python test_unit_layer_all4_2.py
...
if __name__ == "__main__":
    for i in range(5):
        ...
        if i == 0:
            input_fm_p = "fm_14_4/feature1.fm.npy"
            weights_p = "param_14_4/features1.0.weight.npy"

            file_p = "test_unit_all_layer_14_4.v"
        ...
        if i == 1:
            input_fm_p = "fm_14_4/feature2.fm.npy"
            weights_p = "param_14_4/features2.0.weight.npy"
            ...
            input_fm = np.load(str(input_fm_p))
            weights = np.load(str(weights_p))
            filename = "test_unit/test_unit_all_layer_14_4.v"
        ...
        if i == 2:
            input_fm_p = "fm_14_4/feature3.fm.npy"
            weights_p = "param_14_4/features3.0.weight.npy"
        ...
        if i == 3:
            input_fm_p = "fm_14_4/feature4.fm.npy"
            weights_p = "param_14_4/features4.0.weight.npy"
